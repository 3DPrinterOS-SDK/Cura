...
UM.Dialog
{
    ...
    ScrollView
    {
        ...
        ListView
        {
            ...
            {
                projectsModel.append({ name: "LUGOCura", description: catalog.i18nc("@label", "Graphical user interface"), license: "LGPLv3", url: "https://github.com/3DPrinterOS-SDK/Cura/tree/formers_farm_4.12" });
