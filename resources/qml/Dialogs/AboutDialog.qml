    ...
    ScrollView
    {
        ...
        ListView
        {
            ...
            Component.onCompleted:
            {
                ...
                projectsModel.append({ name: "OctoPrintPlugin", description: catalog.i18nc("@label", "Cura-OctoPrintPlugin"), license: "AGPL-3.0", url: "https://github.com/fieldOfView/Cura-OctoPrintPlugin" });
            }
        }
    }
