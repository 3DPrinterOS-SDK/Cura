...
SettingItem
{
    ...
    baseHeight: UM.Theme.getSize("section").height * 4
    controlContainerHeight: UM.Theme.getSize("setting_control").height * 4
    onFocusReceived:
    {
    ...
    contents: Rectangle
    {
        ...
        height: UM.Theme.getSize("setting_control").height * 4
