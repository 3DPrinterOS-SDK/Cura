...
class GCodeWriter(MeshWriter):
    ...
    def write(self, stream, nodes, mode = MeshWriter.OutputMode.TextMode):
        ...
        camera_cool_enabled = Application.getInstance().getGlobalContainerStack().getProperty("cool_fan_camera_enabled", "value") and Application.getInstance().getGlobalContainerStack().getProperty("cool_fan_camera_enabled", "enabled")
