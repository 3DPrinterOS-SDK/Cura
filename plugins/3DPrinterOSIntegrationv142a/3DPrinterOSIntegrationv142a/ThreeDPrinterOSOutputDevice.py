...
from . ThreeDPrinterOSUtils import ThreeDPrinterOSUtils
...
class ThreeDPrinterOSOutputDevice(OutputDevice):
    def __init__(self, pluginId):
        super().__init__("3dprinteros")

        self._pluginId = pluginId
        self.setName(catalog.i18nc("@item:inmenu", "Local File"))
        self.setShortDescription(catalog.i18nc("@action:button Preceded by 'Ready to'.", "Upload to 3DPrinterOS"))
        self.setDescription(catalog.i18nc("@info:tooltip", "Upload to 3DPrinterOS cloud"))
        self.setIconName("upload_3d")
        self.pluginUtils = ThreeDPrinterOSUtils()
    ...
    def _createDialogue(self):
        ...
        qml_file = QUrl.fromLocalFile(os.path.join(PluginRegistry.getInstance().getPluginPath(self._pluginId), "PluginMain.qml"))
