...
class ThreeDPrinterOSOutputDevicePlugin(OutputDevicePlugin):
    def __init__(self):
        ...
        Application.getInstance().getPreferences().addPreference("3dprinteros/last_used_type", "")
        Application.getInstance().getPreferences().addPreference("3dprinteros/dialog_save_path", "")
