...
class SettingVisibilityPresetsModel(QObject):
    ...
    def __init__(self, preferences: Preferences, parent = None) -> None:
        ...
        self._custom_preset = SettingVisibilityPreset(preset_id = "custom", name = catalog.i18nc("@button", "Custom"), weight = -100)
    ...
    def _populate(self) -> None:
        ...
        for file_path in Resources.getAllResourcesOfType(CuraApplication.ResourceTypes.SettingVisibilityPreset):
            ...
            setting_visibility_preset.setName(catalog.i18nc("@button", setting_visibility_preset.name))
            print(setting_visibility_preset.name)
            items.append(setting_visibility_preset)

        # Add the "all" visibility:
        all_setting_visibility_preset = SettingVisibilityPreset(preset_id = "all", name = catalog.i18nc("@button", "All"), weight = 9001)
